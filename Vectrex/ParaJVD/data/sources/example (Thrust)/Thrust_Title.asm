...
CreditsText:
  db '                VECTREX THRUST BY VILLE KRUMLINDE 2004. MUSIC BY ROB HUBBARD. ORIGINAL C64 THRUST BY JEREMY C SMITH 1985. THIS GAME IS FREEWARE. VISIT WWW.ELDEAN.SE/VECTREX                 '
CreditsTextEnd:
