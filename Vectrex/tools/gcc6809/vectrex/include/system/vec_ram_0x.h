...
// ***************************************************************************
//
// Vectrex C for gcc6809 - extended adresses (BIOS ram locations)
...
extern unsigned int			Vec_Counter_1		__attribute__((section(".dpc8")));	// 0xC82E, First  counter byte
extern unsigned int			Vec_Counter_2		__attribute__((section(".dpc8")));	// 0xC82F, Second counter byte
extern unsigned int			Vec_Counter_3		__attribute__((section(".dpc8")));	// 0xC830, Third  counter byte
extern unsigned int			Vec_Counter_4		__attribute__((section(".dpc8")));	// 0xC831, Fourth counter byte
extern unsigned int			Vec_Counter_5		__attribute__((section(".dpc8")));	// 0xC832, Fifth  counter byte
extern unsigned int			Vec_Counter_6		__attribute__((section(".dpc8")));	// 0xC833, Sixth  counter byte
extern unsigned long int	Vec_RiseRun_Tmp		__attribute__((section(".dpc8")));	// 0xC834, Temp storage word for rise/run
extern unsigned int			Vec_Angle			__attribute__((section(".dpc8")));	// 0xC836, Angle for rise/run and rotation calculations
