...
// ***************************************************************************
//
// Vectrex C for gcc6809 - non-inlined top-layer calls
...
__NO_INLINE void _Wait_Recal(void); // 0xF192
__NO_INLINE void _Set_Refresh(void); // 0xF1A2, not official!
__NO_INLINE void _Recalibrate(void); // 0xF2E6 
__NO_INLINE void _Reset0Ref_D0(void); // 0xF34A
__NO_INLINE void _Check0Ref(void); // 0xF34F 
__NO_INLINE void _Reset0Ref(void); // 0xF354 
__NO_INLINE void _Reset_Pen(void); // 0xF35B
__NO_INLINE void _Reset0Int(void); // 0xF36B
...
__NO_INLINE void _Dec_3_Counters(void); // 0xF55A
__NO_INLINE void _Dec_6_Counters(void); // 0xF55E
__NO_INLINE void _Dec_Counters(volatile const unsigned int b, void* volatile const x); // 0xF563
...
__NO_INLINE void _DP_to_D0(void); // 0xF1AA
__NO_INLINE void _DP_to_C8(void); // 0xF1AF
...
__NO_INLINE void _Delay_3(void); // 0xF56D, 30 cycles
__NO_INLINE void _Delay_2(void); // 0xF571, 25 cycles
__NO_INLINE void _Delay_1(void); // 0xF575, 20 cycles
__NO_INLINE void _Delay_0(void); // 0xF579, 12 cycles
__NO_INLINE void _Delay_b(volatile const unsigned int b); // 0xF57A, 5*B + 10 cycles
__NO_INLINE void _Delay_RTS(void); // 0xF57D, 5 cycles
...
__NO_INLINE void _Dot_ix_b(volatile const unsigned int b, void* volatile const x); // 0xF2BE 
__NO_INLINE void _Dot_ix(void* volatile const x); // 0xF2C1 
__NO_INLINE void _Dot_d(volatile const int a, volatile const int b); // 0xF2C3 
__NO_INLINE void _Dot_dd(volatile const long int d); // 0xF2C3 
__NO_INLINE void _Dot_here(void); // 0xF2C5
__NO_INLINE void _Dot_List(void* volatile const x); // 0xF2D5
__NO_INLINE void _Dot_List_Reset(void* volatile const x); // 0xF2DE
...
__NO_INLINE void _Print_Str_hwyx(void* volatile const u); // 0xF373 
__NO_INLINE void _Print_Str_yx(const void* volatile const u); // 0xF378
__NO_INLINE void _Print_Str_d(volatile const int a, volatile const int b, const void* volatile const u); // 0xF37A
__NO_INLINE void _Print_Str_dd(volatile const long int d, void* volatile const u); // 0xF37A
__NO_INLINE void _Print_List_hw(void* volatile const u); // 0xF385
__NO_INLINE void _Print_List(void* volatile const u); // 0xF38A, not official!
__NO_INLINE void _Print_List_chk(void* volatile const u); // 0xF38C 
__NO_INLINE void _Print_Ships_x(volatile const unsigned int a, volatile const unsigned int b, void* volatile const x); // 0xF391 
__NO_INLINE void _Print_Ships(volatile const unsigned int a, volatile const unsigned int b, volatile const unsigned long int x); // 0xF393 
__NO_INLINE void _Print_Str(void* volatile const u); // 0xF495
...
__NO_INLINE void _Draw_Pat_VL_aa(volatile const unsigned int a, void* volatile const x); // 0xF433
__NO_INLINE void _Draw_Pat_VL_a(volatile const unsigned int a, void* volatile const x); // 0xF434
__NO_INLINE void _Draw_Pat_VL(void* volatile const x); // 0xF437

#if 0
__NO_INLINE void _Draw_Pat_VL_d(volatile const long unsigned int d, void* volatile const x); // 0xF439, not official
#endif

__NO_INLINE void _Draw_Line_d(volatile const int a, volatile const int b); // 0xF3DF
__NO_INLINE void _Draw_Line_dd(volatile const long int d); // 0xF3DF
__NO_INLINE void _Draw_VLc(void* volatile const x); // 0xF3CE, count y x y x ...
__NO_INLINE void _Draw_VL_ab(volatile const unsigned int a, volatile const unsigned int b, void* volatile const x); // 0xF3D8
__NO_INLINE void _Draw_VL(void* volatile const x); // 0xF3DD, y x y x ...
__NO_INLINE void _Draw_VLcs(void* volatile const x); // 0xF3D6, count scale y x y x ...
__NO_INLINE void _Draw_VL_b(volatile const unsigned int b, void* volatile const x); // 0xF3D2, x x y x ...
__NO_INLINE void _Draw_VL_a(volatile const unsigned int a, void* volatile const x); // 0xF3DA, y x y x ...
...
__NO_INLINE void _Mov_Draw_VLc_a(void* volatile const x); // 0xF3AD, count y x y x ...
__NO_INLINE void _Mov_Draw_VL_b(volatile const unsigned int b, void* volatile const x); // 0xF3B1, y x y x ...
__NO_INLINE void _Mov_Draw_VLcs(void* volatile const x); // 0xF3B5, count scale y x y x ...
__NO_INLINE void _Mov_Draw_VL_ab(volatile const unsigned int a, volatile const unsigned int b, void* volatile const x); // 0xF3B7
__NO_INLINE void _Mov_Draw_VL_a(volatile const unsigned int a, void* volatile const x); // 0xF3B9, y x y x ...
__NO_INLINE void _Mov_Draw_VL(void* volatile const x); // 0xF3BC, y x y x ...
__NO_INLINE void _Mov_Draw_VL_d(volatile const int a, volatile const int b); // 0xF3BE, y x
...
__NO_INLINE void _Draw_VL_mode(volatile const const void* x); // 0xF46E
__NO_INLINE void _Draw_VLp_7F(void* volatile const x); // 0xF408, pattern y x pattern y x ... 0x01
__NO_INLINE void _Draw_VLp_FF(void* volatile const x); // 0xF404, pattern y x pattern y x ... 0x01
__NO_INLINE void _Draw_VLp_b(volatile const unsigned int b, void* volatile const x); // 0xF40E, scale pattern y x pattern y x ... 0x01
__NO_INLINE void _Draw_VLp(void* const x); // 0xF410, pattern y x pattern y x ... 0x01
__NO_INLINE void _Draw_VLp_scale(void* volatile const x); // 0xF40C, scale pattern y x pattern y x ... 0x01
__NO_INLINE void _Rot_VL_Mode(volatile const unsigned int a, void* volatile const x, void* volatile const u); // 0xF61F 
__NO_INLINE void _Rot_VL_Pack(void* volatile const x, void* volatile const u); // 0xF622
...
__NO_INLINE void _Draw_Grid_VL(void* volatile const x, void* volatile const y); //0xFF9F, not official
...
__NO_INLINE unsigned int _Bitmask_a(volatile const unsigned int a); // 0xF57E

__NO_INLINE long unsigned int _Abs_a_b(volatile const int a, volatile const int b); // 0xF584
__NO_INLINE unsigned int _Abs_b(volatile const int b); // 0xF58B

__NO_INLINE unsigned int _Rise_Run_Angle(volatile const int a, volatile const int b); // 0xF593
__NO_INLINE long unsigned int _Get_Rise_Idx(volatile const int a); // 0xF5D9
__NO_INLINE int _Xform_Sin(volatile const int a); // 0xF5DB
__NO_INLINE long unsigned int _Get_Rise_Run(void); // 0xF5EF

__NO_INLINE int _Xform_Run_a(volatile const int a); // 0xF65B 
__NO_INLINE int _Xform_Run(void); // 0xF65D 
__NO_INLINE int _Xform_Rise_a(volatile const int a); // 0xF661 
...
__NO_INLINE void _Clear_x_b(volatile const unsigned int b, void* volatile const x); // 0xF53F
__NO_INLINE void _Clear_C8_RAM(void); // 0xF542, never used by GCE carts?
__NO_INLINE void _Clear_x_256(void* volatile const x); // 0xF545
__NO_INLINE void _Clear_x_d(void* volatile const x, volatile const long unsigned int d); // 0xF548
...
__NO_INLINE void _Move_Mem_a_1(volatile const unsigned int a, void* volatile const x, void* volatile const u); // 0xF67F 
__NO_INLINE void _Move_Mem_a(volatile const unsigned int a, void* volatile const x, void* volatile const u); // 0xF683
...
__NO_INLINE void _Clear_x_b_80(volatile const int b, void* volatile const x); // 0xF550
__NO_INLINE void _Clear_x_b_a(volatile const unsigned int a, volatile const unsigned int b, void* volatile const x); // 0xF552
...
__NO_INLINE void _Read_Btns_Mask(volatile const unsigned int a); // 0xF1B4
__NO_INLINE void _Read_Btns(void); // 0xF1BA
__NO_INLINE void _Joy_Analog(void); //0xF1F5
__NO_INLINE void _Joy_Digital(void); // 0xF1F8
...
__NO_INLINE void _Select_Game(volatile const unsigned int b, volatile const unsigned int a); // 0xF7A9
__NO_INLINE void _Display_Option(volatile const unsigned int b, const void* const x); // 0xF835 - inofficial!
...
__NO_INLINE void _Reset(void); // 0xF000
__NO_INLINE void _Init_VIA(void); // 0xF14C
__NO_INLINE void _Init_OS_RAM(void); // 0xF164
__NO_INLINE void _Init_OS(void); // 0xF18B
__NO_INLINE void _Init_Music_Buf(void); // 0xF533
...
__NO_INLINE void _Clear_Score(void* volatile const x); //0xF84F
__NO_INLINE void _Add_Score_a(volatile const unsigned int a, void* volatile const x); // 0xF85E
__NO_INLINE void _Add_Score_d(void* volatile const x, volatile const long unsigned int d); // 0xF87C
__NO_INLINE void _Strip_Zeros(volatile const unsigned int b, void* volatile const x); // 0xF8B7
__NO_INLINE unsigned int _Compare_Score(void* volatile const x, void* volatile const u); // 0xF8C7
__NO_INLINE void _New_High_Score(void* volatile const x, void* volatile const u); //0xF8D8
...
__NO_INLINE void _Sound_Byte(volatile const unsigned int a, volatile const unsigned int b); // 0xF256
__NO_INLINE void _Sound_Byte_x(volatile const unsigned int a, volatile const unsigned int b, void* volatile const x); // 0xF259 
__NO_INLINE void _Clear_Sound(void); // 0xF272 
__NO_INLINE void _Sound_Bytes(void* volatile const u); // 0xF27D 
__NO_INLINE void _Sound_Bytes_x(void* volatile const x, void* volatile const u); // 0xF284
__NO_INLINE void _Do_Sound(void); // 0xF289
__NO_INLINE void _Do_Sound_x(void* volatile const x); // 0xF28C, not official! 
__NO_INLINE void _Init_Music_chk(volatile const const void* u); // 0xF687
__NO_INLINE void _Init_Music(void* volatile const u); // 0xF68D 
__NO_INLINE void _Init_Music_a(void* volatile const x, void* volatile const u); // 0xF690 
__NO_INLINE void _Init_Music_x(void* volatile const u); // 0xF692 
__NO_INLINE void _Stop_Sound(void); // 0xF742
__NO_INLINE void _Explosion_Snd(volatile const const void* u); // 0xF92E 
__NO_INLINE void _Set_Amp(volatile const unsigned int b); // 0xF9CA
...
__NO_INLINE void _Moveto_x_7F(void* volatile const x); // 0xF2F2
__NO_INLINE void _Moveto_d_7F(volatile const int a, volatile const int b); // 0xF2FC
__NO_INLINE void _Moveto_dd_7F(volatile const long int d); // 0xF2FC
__NO_INLINE void _Moveto_ix_FF(void* volatile const x); // 0xF308 
__NO_INLINE void _Moveto_ix_7F(void* volatile const x); // 0xF30C 
__NO_INLINE void _Moveto_ix_b(volatile const unsigned int b, void* volatile const x); // 0xF30E 
__NO_INLINE void _Moveto_ix(void* volatile const x); // 0xF310 
__NO_INLINE void _Moveto_d(volatile const int a, volatile const int b); // 0xF312
__NO_INLINE void _Moveto_dd(volatile const long int d); // 0xF312, performance opt!
...
__NO_INLINE void _Intensity_1F(void); // 0xF29D
__NO_INLINE void _Intensity_3F(void); // 0xF2A1 
__NO_INLINE void _Intensity_5F(void); // 0xF2A5 
__NO_INLINE void _Intensity_7F(void); // 0xF2A9 
__NO_INLINE void _Intensity_a(volatile const unsigned int a); // 0xF2AB
...
__NO_INLINE unsigned int _Obj_Will_Hit_u(volatile const int a, volatile const int b, volatile const long int x, volatile const long int y, volatile const long int u); // 0xF8E5
__NO_INLINE unsigned int _Obj_Will_Hit(volatile const int a, volatile const int b, volatile const long int x, volatile const long int y, volatile const long int* u); // 0xF8F3

__NO_INLINE unsigned int _Obj_Hit(volatile int a, volatile const int b, volatile const long int x, volatile const long int y); // 0xF8FF
...
__NO_INLINE long unsigned int _Rise_Run_X(volatile const int a, volatile const int b); // 0xF5FF
__NO_INLINE long unsigned int _Rise_Run_Y(volatile const int a, volatile const int b); // 0xF601
__NO_INLINE long unsigned int _Rise_Run_Len(volatile const int a); // 0xF603
__NO_INLINE void _Rot_VL_ab(volatile const unsigned int a, volatile const unsigned int b, void* volatile const x, void* volatile const u);  // 0xF610
__NO_INLINE void _Rot_VL_Diff(volatile const unsigned int b, void* volatile const x, void* volatile const u); // 0xF613
__NO_INLINE void _Rot_VL(void* volatile const x, void* volatile const u); // 0xF616 

// rotate vl, not official!
// (mode, rel_y, rel_x)+, 0x01
// __NO_INLINE _Rot_VL_Mode(volatile const unsigned int a, void* volatile const x, void* volatile const u); // 0xF61F, d, x, u
__NO_INLINE void _Rot_VL_M_dft(void* volatile const x, void* volatile const u); // 0xF62B, d, x, u, 
...
__NO_INLINE void _Dot_y(volatile const long int y); // 0xEA5D
__NO_INLINE void _Dot_py(void* volatile const y); // 0xEA6D

__NO_INLINE void _Draw_Pack(volatile const unsigned int b, void* volatile const x, volatile const long int y); // 0xEA7F
__NO_INLINE void _Draw_Pack_py(volatile const unsigned int b, void* volatile const x, void* volatile const y); // 0xEA8D

__NO_INLINE void _Print_Msg(void* volatile const y, void* volatile const u); // 0xEAA8
__NO_INLINE unsigned int _Rnd_Cone(void); // 0xEA3E

__NO_INLINE long unsigned int _Displ8_xy(volatile const unsigned int a, volatile const unsigned int b); // 0xE7B5
__NO_INLINE long unsigned int _Displ16_xy(volatile const unsigned int a, volatile const unsigned int b);// 0xE7B5
